# Study Design — Security Tooling Adoption & Intervention in AI-Assisted Software Development 
...
5) Record per-run provenance in `data_derived/<YYYY-MM-DD>/run_manifest.json`:
   ...
   - inline-comment table choice (`pr_review_comments_v2` by default),
